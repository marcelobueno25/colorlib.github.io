...
$(window).on("scroll",function(){$("section").each(function(){var t=$(window).scrollTop();$(this).offset().top-t<200?$(this).addClass("active").change():$(this).removeClass("active")})}),$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var t=$(this.hash);if((t=t.length?t:$("[name="+this.hash.slice(1)+"]")).length)return $("html, body").animate({scrollTop:t.offset().top},700),!1}});
$(document).ready(function(){$(".nav-icon").click(function(){$(".nav-list").toggleClass("active")})}),$(window).scroll(function(){50<$(this).scrollTop()||50<$(this).scrollTop()?$(".nav-opaque").addClass("opaque"):$(".nav-opaque").removeClass("opaque")});
var swiper=new Swiper(".screenshot .swiper-container",{slidesPerView:5,centeredSlides:!0,spaceBetween:30,loop:!0,autoplay:{delay:4500,disableOnInteraction:!1},pagination:{el:".swiper-pagination",clickable:!0}});
var swiper=new Swiper(".testimonials .swiper-container",{slidesPerView:3,centeredSlides:!0,spaceBetween:0,loop:!0,autoplay:{delay:4500,disableOnInteraction:!1},pagination:{el:".swiper-pagination",clickable:!0}});